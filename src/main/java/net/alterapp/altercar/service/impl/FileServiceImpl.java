...
import net.alterapp.altercar.model.responses.errors.FileStorageException;
import net.alterapp.altercar.model.responses.errors.MyFileNotFoundException;
...
public class FileServiceImpl implements FileService {
    ...
    public FileServiceImpl(FileStorageProperties fileStorageProperties) {
        ...
        try {
            ...
            Files.createDirectories(this.fileStorageLocation.resolve("car-brand-logos"));
            Files.createDirectories(this.fileStorageLocation.resolve("tire-brand-logos"));
            Files.createDirectories(this.fileStorageLocation.resolve("tire-photos"));
            Files.createDirectories(this.fileStorageLocation.resolve("partner-logos"));
        } catch (Exception ex) {
    ...
    public String storeFile(MultipartFile file, String type) {
        ...
        switch (type) {
            ...
            case "car-brand-logo": directory = "car-brand-logos/"; break;
            case "tire-brand-logo": directory = "tire-brand-logos/"; break;
            case "tire-photo": directory = "tire-photos/"; break;
            case "partner-logo": directory = "partner-logos/"; break;
        }
